...
<body>
      ...
      <div class="container my-5">
        <div class="card transparent-card" style="width: 100%; background-color: rgba(255, 255, 255, 0); border: none; box-shadow: none; margin-top: 10%">
            <div class="card-body"> 
                <h3 class="card-title front_yellow_text">NARAUYO SAYO! </h3>
